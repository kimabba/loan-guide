  ...
  return (
    <div className="border-b border-border/50">
      <button
        ...
        className="flex w-full items-center justify-between py-3 px-3 -mx-3 rounded-lg text-left transition-all hover:bg-primary/10 hover:text-primary cursor-pointer"
      >
